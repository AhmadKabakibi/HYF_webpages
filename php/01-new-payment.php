...
echo             '       <form name="donateform" method="post" action="" role="form">';
echo             '               <button type="button" class="close" data-dismiss="modal"><i class="fa fa-times"></i></button>';
echo             '               <h4>DONATE</h4>';
echo             '               <div class="form-group">';
echo                            '    <div class="input-group">';
echo                            '        <div class="input-group-addon"><i class="fa fa-eur"></i></div>';
echo                            '        <input type="text" class="form-control" placeholder="Amount">';
echo                            '    </div>';
echo                            '</div>';
echo                        '<button type="submit" class="btn btn-danger btn-sm">Donate</button>';
...
try
{
	...
	/*
	 * Payment parameters:
	 *   amount        Amount in EUROs. This example creates a € 50,- payment.
	...
	$payment = $mollie->payments->create(array(
		"amount"       => $_POST['amount'],
		"description"  => "HackYourFuture Denotation payment",
